...
await describe('Test Loggage', async () => {
  await it('should set the verbosity level correctly', () => {
  ...
  await it('should set the name correctly', () => {
    const loggage = new Loggage({ name: 'My Project', verbosity: Verbosity.INFO, save: false });
  ...
  await it('should set the log to file correctly', () => {
    const loggage = new Loggage({ name: 'My Project', verbosity: Verbosity.INFO, save: false });
  ...
  await it('should send the correct error message', () => {
    const loggage = new Loggage({ name: 'My Project', verbosity: Verbosity.INFO, save: false });

    loggage.error('This is an error message');
  });

  await it('should send the correct fatal error message', () => {
